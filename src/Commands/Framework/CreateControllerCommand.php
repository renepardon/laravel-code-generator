...
class CreateControllerCommand extends ControllerCommandBase
{
    ...
    public function handle()
    {
        ...
        $viewVariablesForIndex = $this->getCompactVariablesFor($resource->fields,
            $this->getPluralVariable($input->modelName), 'index');
        $viewVariablesForShow = $this->getCompactVariablesFor($resource->fields,
            $this->getSingularVariable($input->modelName), 'show');
        $viewVariablesForEdit = $this->getCompactVariablesFor($resource->fields,
            $this->getSingularVariable($input->modelName), 'form');
