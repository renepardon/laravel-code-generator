...
class CreateRoutesCommand extends Command
{
    ...
    public function handle()
    {
        ...
        if ($this->isRouteNameExists($this->getDotNotationName($this->getModelName($input->modelName), $namePrefix,
            'index'))) {
    ...
    protected function getCommandInput()
    {
        ...
        $controllerDirectory = trim($this->option('controller-directory')) ?: $this->getDefaultControllerDirectory($type,
            $apiVersion);
