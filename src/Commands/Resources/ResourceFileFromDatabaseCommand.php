...
class ResourceFileFromDatabaseCommand extends ResourceFileCommandBase
{
    ...
    protected function getParser()
    {
        ...
        $class = sprintf('Renepardon\CodeGenerator\DatabaseParsers\%sParser', ucfirst($driver));
    ...
    protected function createVirtualMigration(Resource $resource, $destenationFile, $tableName)
    {
        ...
        $capsule = MigrationTrackerCapsule::get($tableName, $this->getModelName(),
            Helpers::convertSlashToBackslash($destenationFile));
