...
use Renepardon\CodeGenerator\Models\ScaffoldInput;
...
class CreateMappedResourcesCommand extends Command
{
    ...
    protected function getValidInputs(array $objects, ScaffoldInput $originalInput)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $input->resourceFile = $this->getValue($object, 'resource-file',
                Helpers::makeJsonFileName($input->modelName));
            ...
            $input->formRequestDirectory = $this->getValue($object, 'form-request-directory',
                $input->formRequestDirectory);
