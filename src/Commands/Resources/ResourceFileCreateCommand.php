...
use Renepardon\CodeGenerator\Commands\Bases\ResourceFileCreatorCommandBase;
...
class ResourceFileCreateCommand extends ResourceFileCreatorCommandBase
{
    ...
    public function handle()
    {
        ...
        $resource->setDefaultApiDocLabels($input->modelName, self::makeLocaleGroup($input->modelName),
            $input->translationFor);
