...
abstract class ControllerCommandBase extends ControllerRequestCommandBase
{
    ...
    protected function processCommonTasks($input, $resource, &$stub)
    {
        ...
        $dataMethod = $this->getDataMethod($resource->fields, $this->requestNameSpace . '\\' . $this->requestName,
            $input);
        ...
        return $this->replaceGetDataMethod($stub, $dataMethod)
            ...
            ->replaceFileMethod($stub,
                $this->getUploadFileMethod($resource->fields, $this->getFullClassToExtend(), $input->withFormRequest))
