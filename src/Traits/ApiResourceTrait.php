...
namespace Renepardon\CodeGenerator\Traits;
...
trait ApiResourceTrait
{
    ...
    protected function getApiResourceClassName($modelName)
    {
        ...
        return $cName ? Str::finish($cName,
            Config::getApiResourceNamePostFix()) : Helpers::makeApiResourceName($modelName);
    }
    ...
    protected function getApiResourceCollectionClassName($modelName)
    {
        ...
        return $cName ? Str::finish($cName,
            Config::getApiResourceCollectionNamePostFix()) : Helpers::makeApiResourceCollectionName($modelName);
    }
     ...
     * @return string
     */
    protected function getModelApiArray(
        array $fields,
        $modelName,
        $forApiCollectionClass = false,
        $prefix = '            '
    ) {
        $properties = [];
