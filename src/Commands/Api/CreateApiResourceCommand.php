...
namespace Renepardon\CodeGenerator\Commands\Api;
...
class CreateApiResourceCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $resource = Resource::fromFile($input->resourceFile, 'Renepardon');
        ...
        return $this->replaceNamespace($stub, $this->getClassNamepace($input->isCollection))
            ->replaceModelApiArray($stub,
                $this->getModelApiArray($resource->fields, $input->modelName, $input->isCollection))
            ...
            ->replaceTransformMethod($stub,
                $this->getTransformMethod($input, $resource->fields, $input->isCollection, $input->isCollection))
